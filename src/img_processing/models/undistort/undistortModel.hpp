#ifndef undistortModel_HPP
#define undistortModel_HPP
...
class undistortModel : public NodeDataModel
{
...
public:
  ...
  { return QStringLiteral("undistort"); }
