#include "Formundistort.h"
#include "ui_Formundistort.h"

Formundistort::Formundistort(QWidget *parent) :
  QWidget(parent),
  ui(new Ui::Formundistort)
{
  ui->setupUi(this);
  ...
  workerThread = new Threadundistort();
  dialog = new Dialogundistort();
...
Formundistort::~Formundistort()
{
  delete ui;
}

void Formundistort::on_pushButton_nodeEnable_clicked()
{
...
void Formundistort::on_pushButton_prop_clicked()
{
